...
document.querySelectorAll('.cert-view-btn').forEach(button => {
    button.addEventListener('click', function(e) {
        e.preventDefault(); // Prevents opening the image in a new page
        modal.style.display = "block";
        modalImg.src = this.getAttribute('href'); // Grabs the path from the 'href'
        document.getElementById("caption").innerText = this.parentElement.querySelector('h4').innerText;
    });
});
